...
class AppLocalizationsCs extends AppLocalizations {
  ...
  @override
  String get tutorialStatistics => 'Režim Statistika – práce se sadami.\n\nTlačítka: SETS MC MR M+ STATS C DEL / 7 8 9 * 4 5 6 - 1 2 3 + 0 . ; =.\nSETS: vytvořit/přejmenovat/smazat/přepínat sady, přidat pole.\nM+ krátce: uloží čísla z displeje (oddělovač ;) do aktivní sady. M+ dlouze / Ctrl+M: zadá počet opakování.\nMC: vymaže sadu. MR: přehled/editace dat. STATS: souhrn (N, MIN, MAX, SUM, MEAN, VAR, SD, MED, MODE, CV, WMEAN).\nPokročilé funkce: MEAN/SD/VAR/SUM/MED/MODE/CV/WMEAN/MIN/MAX + čtení poslední dávky. Více polí: hodnoty zadávej jako např. 80;2 pro WMEAN.';
