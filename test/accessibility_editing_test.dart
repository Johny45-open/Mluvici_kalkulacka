...
void main() {
  ...
  group('Editing draft', () {
    testWidgets('B theme revert', (tester) async {
      ...
      final beforeV2 = (await SharedPreferences.getInstance()).getString(
      ...
      final midV2 = (await SharedPreferences.getInstance()).getString(
        'accessibility_profiles_v2',
      );
      ...
      final afterV2 = (await SharedPreferences.getInstance()).getString(
        'accessibility_profiles_v2',
      );
